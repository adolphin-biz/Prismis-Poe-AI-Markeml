...
RUN apt update && apt install -y cron curl git fish nano wget tar gzip openssl unzip bash python3 python3-pip php php-cli php-fpm php-zip php-mysql php-curl php-gd php-common php-xml php-xmlrpc gcc make
